(() => {
  const WAZEENS = [
    {id:"mehrab-uddin",name:"Pirjada Mehrab Uddin Siddiqui Al Quraish",bn:"পিরজাদা মেহরাব উদ্দিন সিদ্দিকী আল কুরাইশ",role:"CONTROLLER • ULAMA BOARD",roleBn:"কেন্দ্রীয় নিয়ন্ত্রক",image:"assets/FB_IMG_1789891917922.jpg",district:"ফুরফুরা শরীফ",education:"—",experience:"উলামা বোর্ডের কেন্দ্রীয় দায়িত্ব",bio:"WAYEJIN E FURFURA SHARIF-এর সাংগঠনিক নেতৃত্ব ও উলামা ঐক্যের সঙ্গে যুক্ত।"},
    ...
    {id:"jamat-ali",name:"Maulana Jamat Ali",bn:"মাওলানা জামাত আলী",role:"CHIEF DIRECTOR • ADVISOR COMMITTEE",roleBn:"প্রধান পরিচালক • উপদেষ্টা কমিটি",image:"assets/Screenshot_2026-09-18-03-21-02-19_320a9a695de7cdce83ed5281148d6f19.jpg",district:"পশ্চিমবঙ্গ",education:"—",experience:"উপদেষ্টা ও সাংগঠনিক দায়িত্ব",bio:"উপদেষ্টা কমিটি ও সাংগঠনিক পরিকল্পনার সঙ্গে যুক্ত।"},
    {id:"khairuzzaman",name:"Maulana Khairuzzaman",bn:"মাওলানা খায়রুজ্জামান",role:"GENERAL SECRETARY • ULAMA BOARD",roleBn:"সাধারণ সম্পাদক",image:"assets/Screenshot_2026-09-20-13-45-39-25_a23b203fd3aafc6dcb84e438dda678b6.jpg",district:"পশ্চিমবঙ্গ",education:"—",experience:"সাংগঠনিক ও প্রশাসনিক দায়িত্ব",bio:"West Bengal Ulama Board-এর সাধারণ সম্পাদক হিসেবে সাংগঠনিক কাজের সঙ্গে যুক্ত।"}
  ];
  window.WBUB_WAZEENS=WAZEENS;
  const esc=v=>String(v??"").replace(/[&<>"]/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"}[c]));
  const folder=w=>'<a class="wazeen-folder" href="wazeen-profile.html?id='+encodeURIComponent(w.id)+'"><span class="folder-tab">📁 PROFILE</span><img src="'+esc(w.image)+'" alt="'+esc(w.name)+'"><h3>'+esc(w.bn||w.name)+'</h3><p>'+esc(w.roleBn||w.role)+'</p><span class="open">প্রোফাইল খুলুন →</span></a>';
