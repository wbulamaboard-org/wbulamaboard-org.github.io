(() => {
  ...
  function addLanguageSelector(){
    ...
    const style=document.createElement('style'); style.textContent='.site-language{display:flex;align-items:center;gap:6px;z-index:9999;margin-left:12px;flex:0 0 auto}.site-language span{font-size:15px;line-height:1}.site-language select{appearance:auto;min-width:94px;border:1px solid #d8d8d8;border-radius:6px;background:#fff;color:#333;padding:7px 8px;font-size:12px;font-weight:600;cursor:pointer}.site-language select:focus{outline:2px solid #b52f37}@media(max-width:1050px){.site-language{margin-left:8px}.site-language select{min-width:82px;padding:6px 5px;font-size:11px}}@media(max-width:780px){.site-language{position:absolute;right:12px;top:25px;margin:0}.site-language select{min-width:82px;padding:6px 4px;font-size:11px}.header .nav{position:relative;padding-right:94px}}'; document.head.appendChild(style);\n    const box=document.createElement('div');
